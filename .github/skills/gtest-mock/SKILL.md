---
name: gtest-mock
description: Guide for creating and using Google Mock (gmock) objects in C++ unit tests. Use this when asked to create mocks, mock dependencies, set up EXPECT_CALL, or test with mock objects.
---

# Google Mock (gmock) - Mocking Guide
